...
export default function LayoutRoot() {
	...
	useEffect(() => {
		...
		// ❗ chưa load xong routes thì không set title
		if (!isAccessChecked || authGuardDependencies) {
			return;
		}
	...
	}, [enableDynamicTitle, language, location, isAccessChecked, isAuthorized, isLogin, matches, t]);
